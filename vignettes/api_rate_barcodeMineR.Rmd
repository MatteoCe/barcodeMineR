...
For example, if we have a vector of 50 species, we can expect a theoretical execution time for the [get_ncbi_taxonomy](https://matteoce.github.io/barcodeMineR/reference/get_ncbi_taxonomy.html) function of `r paste(round((1/3)*200, 2), "seconds")`:
