...
This can be done "externally", in respect to the _barcodeMineR_ functions, following the [rentrez documentation](https://CRAN.R-project.org/package=rentrez/vignettes/rentrez_tutorial.html#rate-limiting-and-api-keys), specifically with this function:
