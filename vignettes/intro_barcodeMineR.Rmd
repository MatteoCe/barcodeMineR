...
This is the basic usage of the __barcodeMineR__ package. Now you can check how to speed up the recovery of records from the NCBI database by looking at the next [vignette](https://matteoce.github.io/barcodeMineR/articles/api_rate_barcodeMineR.html).
