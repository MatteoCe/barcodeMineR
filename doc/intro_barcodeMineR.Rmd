...
Searching species names, or taxa in general, using the [taxonomy functions](https://matteoce.github.io/barcodeMineR/reference/index.html#taxonomy) follows a set of rules and rational that is described in the vignette [Searching taxonomy](https://matteoce.github.io/barcodeMineR/articles/taxonomy_barcodeMineR.html)
...
This is it, now we have all barcodes available on the major online repositories for the species _Dissostichus mawsoni_. 
